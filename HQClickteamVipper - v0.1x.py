...
root = tk.Tk()
root.title("Vipping tool to decompile CTF Games Refused by Flamesdev")
...
Title = tk.Label(root, text="HQVipper 1.0x", width=0, height=0, font=("Impact", 30), bg="#121212", fg="white")
